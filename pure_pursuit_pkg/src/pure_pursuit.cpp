...
private:
  ...
  ros::Publisher pub_vel_, pub_acker_ , pub_state_;
  tf2_ros::Buffer tf_buffer_;
  tf2_ros::TransformListener tf_listener_;
  tf2_ros::TransformBroadcaster tf_broadcaster_;
  geometry_msgs::TransformStamped lookahead_;
  string map_frame_id_, robot_frame_id_, lookahead_frame_id_ ,model_frame_id_ ;
                             ...
                             lookahead_frame_id_("lookahead")
{
  ...
  nh_private_.param<double>("wheelbase", L_, 0.7);
  ...
  nh_private_.param<string>("model_frame_id", model_frame_id_, "rear_axle_midpoint");
  ...
  cmd_acker_.header.frame_id = model_frame_id_;
  ...
  pub_state_ = nh_.advertise<std_msgs::Bool>("goal_reached", 1);
